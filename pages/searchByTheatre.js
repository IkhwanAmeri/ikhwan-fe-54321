...
const BodyOne = ({ handleSearch, theaterName, setTheaterName, date, setDate, loading }) => {
  return (
...
const Theatre = () => {
  ...
  const handleSearch = async () => {
    setLoading(true);
    try {
      const response = await fetch(`https://821f21ea-3d75-4b17-bac5-f8a0fc587ad2.mock.pstmn.io/specific_movie_theater?theater_name=${theaterName}&amp;d_date=${date}`);
      if (!response.ok) {
